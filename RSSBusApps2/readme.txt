...
Note: The RSSBus application uses security features available in Java Servlet API 3.0. 
Please make sure that the Java server that you select supports Java Servlet API 3.0 
or higher, as earlier versions of the Java Servlet API may introduce security 
vulnerabilities in the RSSBus administration console.

*******************************
* Installing to Tomcat        *
*******************************

Note: Java Servlet API 3.0 is only supported in Tomcat versions 7.0 and later.
